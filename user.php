...
<body>
    ...
    <div class="jumbotron">
        ...
        <br />
        <br />
        <center>Click here to sign up!<button name="signup" onclick="location.href='signup.php'" class="btn btn-primary" style="position: relative; margin-left: 30px;">Sign Up</button></center>
        <br />
        <br />
     </div>
